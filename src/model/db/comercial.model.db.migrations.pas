...
begin
  ...
  if not MetadataExists('select rdb$procedure_name from rdb$procedures'+
  ' where rdb$procedure_name = ''SP_TOP_PRODUTOS_VENDIDOS''') then
    raise Exception.Create('Procedure do relatório não existe!');
